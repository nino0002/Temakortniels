...
var format_folkeskoler3_8 = new ol.format.GeoJSON();
var features_folkeskoler3_8 = format_folkeskoler3_8.readFeatures(json_folkeskoler3_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_folkeskoler3_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_folkeskoler3_8.addFeatures(features_folkeskoler3_8);
var lyr_folkeskoler3_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_folkeskoler3_8, 
                style: style_folkeskoler3_8,
                popuplayertitle: 'folkeskoler3',
                interactive: true,
                title: '<img src="styles/legend/folkeskoler3_8.png" /> folkeskoler3'
            });
...
lyr_Positronnolabels_0.setVisible(true);lyr_Legeplads_1.setVisible(true);lyr_Parker_2.setVisible(true);lyr_Togstationer_3.setVisible(true);lyr_folkeskolerrigtig_4.setVisible(true);lyr_kommuneplan_5.setVisible(true);lyr_matStrandbeskyttelseFlade_Gaeldende_6.setVisible(false);lyr_strandbeskyttelseHvidovre_7.setVisible(true);lyr_folkeskoler3_8.setVisible(true);lyr_togstationer_9.setVisible(true);
var layersList = [lyr_Positronnolabels_0,lyr_Legeplads_1,lyr_Parker_2,lyr_Togstationer_3,lyr_folkeskolerrigtig_4,lyr_kommuneplan_5,lyr_matStrandbeskyttelseFlade_Gaeldende_6,lyr_strandbeskyttelseHvidovre_7,lyr_folkeskoler3_8,lyr_togstationer_9];
...
lyr_folkeskoler3_8.set('fieldAliases', {'fid': 'fid', 'Skolenavn': 'Skolenavn', 'Adresse': 'Adresse', 'By': 'By', 'Hjemmeside': 'Hjemmeside', 'result_num': 'result_num', 'osm_id': 'osm_id', 'display_na': 'display_na', 'category': 'category', 'type': 'type', 'latlong': 'latlong', });
lyr_togstationer_9.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
...
lyr_folkeskoler3_8.set('fieldImages', {'fid': '', 'Skolenavn': 'TextEdit', 'Adresse': 'TextEdit', 'By': 'TextEdit', 'Hjemmeside': 'TextEdit', 'result_num': 'Hidden', 'osm_id': 'Hidden', 'display_na': 'Hidden', 'category': 'Hidden', 'type': 'Hidden', 'latlong': 'Hidden', });
lyr_togstationer_9.set('fieldImages', {'fid': '', 'Name': 'TextEdit', 'description': 'Hidden', 'timestamp': 'Hidden', 'begin': 'Hidden', 'end': 'Hidden', 'altitudeMode': 'Hidden', 'tessellate': 'Hidden', 'extrude': 'Hidden', 'visibility': 'Hidden', 'drawOrder': 'Hidden', 'icon': 'Hidden', });
...
lyr_folkeskoler3_8.set('fieldLabels', {'fid': 'no label', 'Skolenavn': 'no label', 'Adresse': 'no label', 'By': 'no label', 'Hjemmeside': 'no label', });
lyr_togstationer_9.set('fieldLabels', {'fid': 'no label', 'Name': 'no label', });
